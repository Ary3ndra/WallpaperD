...
import org.piarsenal.wallchanger.net.UnsplashPhoto
...
class UnsplashProvider(
    ...
    override suspend fun next(): ProvidedImage? {
        ...
        val imageUrl = when (cfg.quality) {
            org.piarsenal.wallchanger.data.ImageQuality.LOW -> photo.urls.regular
            org.piarsenal.wallchanger.data.ImageQuality.REGULAR -> photo.urls.regular.ifBlank { photo.urls.full }
            org.piarsenal.wallchanger.data.ImageQuality.FULL -> photo.urls.full.ifBlank { photo.urls.raw }
